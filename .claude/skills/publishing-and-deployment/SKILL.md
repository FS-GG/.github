...
| `rendering` | `fs-gg-ui-template` | `0.30.0` | `0.30.0` | `rendering:0.30.0` | dotnet new fs-gg-ui (template/base) + FS.GG.UI.* framework packages |
...
| `audio` | `fs-gg-audio` | `0.5.0` | `0.6.0` | `audio:0.6.0` | FS.GG.Audio.Core/.Host/.Engine/.Elmish public .fsi surfaces — AudioEffect vocabulary + IAudioBackend/IMixingBackend seam + mixing Engine + Audio.Cmd Elmish bridge |
