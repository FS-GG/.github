...
| `game` | `game-sim-core` | `0.13.0` | `0.14.0` | `game:0.14.0` | FS.GG.Game.Core package — BCL-only deterministic simulation primitives plus the packaged fs-gg-game-core-fable-lockstep-v1 bounded Fable source/profile and canonical oracle |
| `game` | `game-scene-adapter` | `0.13.0` | `0.14.0` | `game:0.14.0` | FS.GG.Game.Render package — Adapter (sim-state -> FS.GG.UI.Scene drawables) |
