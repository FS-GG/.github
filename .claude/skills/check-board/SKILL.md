...
```sh
scripts/fsgg-coord scan --include-backlog > /tmp/scan.json   # EVERY item, incl. Done — AND its blockers
...
scripts/fsgg-coord scan --include-backlog             # 4. RE-READ, only if a human boarded anything
```
