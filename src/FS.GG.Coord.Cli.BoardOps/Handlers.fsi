...
module Handlers =
    ...
    val validateLifecycleAuthority: expectation: LifecycleAuthorityExpectation -> lifecycleLog: string -> string list
    ...
    val allocateCommentCapability:
        worker: string -> item: FS.GG.Coord.Types.Ref -> source: string -> Result<CommentCapability, string>
