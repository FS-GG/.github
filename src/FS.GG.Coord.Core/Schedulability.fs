...
module Schedulability =
                        ...
                        | _, None ->
                            ...
                            | DeliveryRoute.Current _ ->
                                ...
                                | Unreadable reason ->
                                    ...
                                    Undetermined
                                        $"the issue body could not be read, so its touch-set is UNKNOWN — not absent (%s{reason})"
                                ...
                                | Declared _ ->
                                    ...
                                    | TouchSet.Usable ->
                                        ...
                                        | Some(_, LeaseExpiredBranchPushed) ->
                                            ...
                                            Undetermined
                                                "the claim's lease has expired, but a pushed item/<n>-* branch is proof of life before its PR is opened (#1055/#581) — not offered, and reap will not collect it"
                                        ...
                                        | Some(_, LivenessUnknown) ->
                                            ...
                                            // free item.
                                            Undetermined
                                                "the claim's lease has expired and we could not check for an open item/<n> PR — an unverifiable claim is not an abandoned one (#581)"
    ...
    let explain (leaseMinutes: int) (item: Item) (result: Schedulability) : string =
        ...
        | WrongStatus NoStatus -> $"%s{id} — no Status on the board: invisible to every scheduler, and nobody set it"
