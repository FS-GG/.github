...
`STALE-CLAIM`, `CLAIM-STATUS-LAG`, `CLAIM-REVIEW-LAG`, `CLOSED-ISSUE-NOT-DONE`, `BLOCKER-CLEARED` and `STATUS-NOT-BLOCKED`
...
> Typed generated facts moved to the focused reference linked from SKILL.md.
