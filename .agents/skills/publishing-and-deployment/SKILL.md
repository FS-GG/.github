...
| `github` | `telemetry-host` | `0.1.3` | `0.1.3` | `github:0.1.3` | optional Linux x64 FS.GG.Telemetry.Host dotnet tool — authenticated workspace-scoped ingestion and private dashboard, independently versioned from the github coordination coherent set |
