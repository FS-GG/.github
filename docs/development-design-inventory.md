...
| [SVG game engine and Fable template: accepted design and delivery roadmap](2026-09-07-064259-svg-game-engine-template-design-roadmap.md), with [SVG-FOUND-01 foundation](roadmaps/svg-game-engine-foundation.md) and [SVG-QUAL-01 installed model qualification](roadmaps/svg-game-engine-installed-model-qualification.md) | Game / SVG | Accepted complete programme; SVG-FOUND-01 complete at the local candidate boundary and SVG-QUAL-01 ready | Qualify installed profile-2 tooling and real reducer correspondence next. S.I.R. remains strictly read-only; protected publication, installed qualification and lifecycle/default activation remain separate. |
