...
| [SVG game engine and Fable template: design and delivery roadmap](2026-09-07-064259-svg-game-engine-template-design-roadmap.md) | Game / SVG | Proposed programme; September 7 roadmap revisions incorporated | Agree component ownership, first usable slice, installed qualification and default-player versus capability coverage. |
