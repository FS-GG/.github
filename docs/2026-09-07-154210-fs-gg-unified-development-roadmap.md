...
**V0 and V1 in parallel; SVG Release B is complete, replay/network/scale candidates are complete, and
SVG-PREVIEW-C is selected**.
...
| **SVG-PREVIEW-C — Installed replay/network/scale preview** | **Preparation complete; publication next** | The [Release-C plan](roadmaps/svg-preview-c.md) targets Rendering 0.31.0, Game 0.16.0, Net 0.6.0 and Templates 0.13.0, retaining Audio 0.6.0 and SDD 1.7.0. | Producer preparation is merged in Rendering #1322, Game #635 and Net #87. Producer publication, Templates adoption/publication and installed public qualification remain pending. |
...
Reconciled SVG feature-milestone states: **63 completed; SVG-PREVIEW-C.2 publication next**.
The current public set is Release B: Rendering 0.30.0, Game 0.15.0, Audio 0.6.0 and Templates 0.12.0.
Replay, networking and scale are qualified as exact generated candidates; Release C owns their publication
and installed public proof. Provider, lifecycle and general template defaults remain unchanged.
...
| **SVG Preview C — SVG-PREVIEW-C** | Planned Templates 0.13.0 composes public Rendering 0.31.0, Game 0.16.0 and Net 0.6.0 for explicitly selected replay/network/scale previews | .3 first changes generated source composition; .2/.4 publish producers/Templates and .5 proves public clean creation and separate retained 0.10–0.12 adoption, conflicts, interruption and rollback. Producer preparation (.1) is complete; publication/adoption and receiver qualification remain pending. No lifecycle/default activation is implied. |
