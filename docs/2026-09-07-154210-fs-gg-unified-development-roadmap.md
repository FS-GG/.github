...
`ce318148d288051eaeb55ebb0e81bb0172d3194523c95ea9caeed5b5091a15cf`. This enters V2 at the prepared
producer boundary only. `.3b` publication, `.3c` opt-in adoption, installed/native acceptance, `OpenV2`, Q4 and
the distinct GS2-09 migration/rehearsal work all remain pending. No package was published, receiver installed,
production writer enabled or live provider effect performed.
...
| **V2 — Callable v2 and migration rehearsal** | **Entered; V2-CALL-01.1–.3a delivered** | Coordination [PR #421](https://github.com/FS-GG/FS.GG.Coordination/pull/421) delivers the strict callable contract and recovery source; [PR #422](https://github.com/FS-GG/FS.GG.Coordination/pull/422), merge `1bd60a3e2dddc37827a7562b133305e1282e2c20`, adds real GitHub/journal composition and prepares exact tool package `FS.GG.Coordination.Cli` 0.1.0 (`sha256:ce318148d288051eaeb55ebb0e81bb0172d3194523c95ea9caeed5b5091a15cf`). | `.3b` publication and `.3c` opt-in adoption remain required before installed behavior changes; installed/native acceptance, `OpenV2`, Q4 and GS2-09 discovery/migration/retry/rollback/omission rehearsal remain pending. |
...
| **GS2-09.9 / V2-CALL-01.1–.3a — Callable ordinary-v2 producer** | **Producer prepared; operation not installed** | Coordination [PR #421](https://github.com/FS-GG/FS.GG.Coordination/pull/421) registers the owning amendment and delivers the source contract and recovery composition; [PR #422](https://github.com/FS-GG/FS.GG.Coordination/pull/422), merge `1bd60a3e2dddc37827a7562b133305e1282e2c20`, composes the real GitHub/journal path and prepares exact tool package `FS.GG.Coordination.Cli` 0.1.0 (`sha256:ce318148d288051eaeb55ebb0e81bb0172d3194523c95ea9caeed5b5091a15cf`) without publishing it. | Complete protected `.3b` publication and `.3c` opt-in adoption, then qualify isolated installed/provider behavior in `.4`. This does not accept GS2-09 migration, Q4, external native effects or `OpenV2`. |

### 0.4 Active work and immediate critical path

1. **Continue entered V2 with V2-CALL-01.3b–.3c, then GS2-09 migration.** Publish and adopt the exact prepared
   callable artifact, qualify its isolated installed/provider journey, and then deliver representative migration,
...
| **Callable ordinary v2 execution** | V2: exact callable source joins observation, deterministic sealed decision, guarded provider effect and durable recovery; producer preparation supplies real GitHub/journal composition and an exact tool candidate | Coordination; V2-CALL-01.1–.2 are delivered in [PR #421](https://github.com/FS-GG/FS.GG.Coordination/pull/421), and `.3a` producer preparation in [PR #422](https://github.com/FS-GG/FS.GG.Coordination/pull/422). `.3b` publication, `.3c` adoption, `.4` installed isolated-provider/native acceptance and `.5` migration handoff remain pending | [V2-CALL-01 callable ordinary-v2 execution plan](https://github.com/FS-GG/FS.GG.Coordination/blob/main/docs/roadmaps/callable-ordinary-v2-execution.md). Prepared package `FS.GG.Coordination.Cli` 0.1.0 is bound to `sha256:ce318148d288051eaeb55ebb0e81bb0172d3194523c95ea9caeed5b5091a15cf`; it is not published or installed and does not claim external effects, `OpenV2`, Q4 or GS2-09 migration completion |
