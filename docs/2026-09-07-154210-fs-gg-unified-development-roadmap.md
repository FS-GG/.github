...
Last reconciled: **2026-09-11 20:14 UTC**. Current frontier: **V0 and V1 in parallel; the accepted SVG
workspace programme completed SVG-SCENE-02.1–.2, with .3 dependency-ready but not selected**.
...
| **SVG-SCENE-02.3** | **Current frontier (unselected)** | Acceptance and ownership remain in the [scene/renderer subroadmap](roadmaps/svg-game-engine-scene-renderer.md) | Paint/definition mapping, serialization/export and browser evidence remain pending; this projection does not select execution. |
| **SVG-SCENE-02.4** | **Pending** | Defined in the [scene/renderer subroadmap](roadmaps/svg-game-engine-scene-renderer.md) | Retained-node reconciliation, accessible input, document reducers and model amendment. |
...
3. **Continue SVG-SCENE-02 after the completed .1–.2 boundary.** Follow the accepted
   ...
   S.I.R. read-only scope. Milestone .3 is dependency-ready but is not selected by this progress update.
