...
V2-CALL-01 **callable ordinary-v2 source window delivered**, **2026-09-17**:
...
composition, guarded advancement and interruption-safe durable recovery. The exact-head native run passed
44 checks with five intentional skips after one unrelated evaluator-fetch retry. This enters V2 at the source
boundary only. V2-CALL-01.3 publication and adoption is next; installed operation, external native acceptance,
`OpenV2`, Q4 and the distinct GS2-09 migration/rehearsal work all remain pending. No production writer or
provider effect was enabled.
...
| **V2 — Callable v2 and migration rehearsal** | **Entered; V2-CALL-01.1–.2 source delivered** | Coordination [PR #421](https://github.com/FS-GG/FS.GG.Coordination/pull/421), merge `86043ea33398877864f9d82a68d10c3def90c6c2`, delivers the strict callable contract, deterministic sealed planning, guarded advancement and durable recovery source. | V2-CALL-01.3 must publish and adopt the exact artifact before installed behavior changes. Installed operation, external native acceptance, `OpenV2`, Q4 and GS2-09 discovery/migration/retry/rollback/omission rehearsal remain pending. |
...
| **GS2-09.9 / V2-CALL-01.1–.2 — Callable ordinary-v2 source** | **Source delivered; operation not installed** | Coordination [PR #421](https://github.com/FS-GG/FS.GG.Coordination/pull/421), merge `86043ea33398877864f9d82a68d10c3def90c6c2`, registers the owning amendment and delivers the exact source contract, planning boundary, guarded advancement and recovery composition. | Publish and adopt the exact callable artifact in V2-CALL-01.3, then qualify isolated installed/provider behavior in .4. This does not accept GS2-09 migration, Q4, external native effects or `OpenV2`. |

### 0.4 Active work and immediate critical path

1. **Continue entered V2 with V2-CALL-01.3, then GS2-09 migration.** Publish and adopt the exact callable
   artifact, qualify its isolated installed/provider journey, and then deliver representative migration,
...
| **Callable ordinary v2 execution** | V2: exact callable source joins observation, deterministic sealed decision, guarded provider effect and durable recovery; publication/adoption then qualifies the installed entry point | Coordination; V2-CALL-01.1–.2 are delivered in [PR #421](https://github.com/FS-GG/FS.GG.Coordination/pull/421). V2-CALL-01.3 publication/adoption is next; .4 installed isolated-provider/native acceptance and .5 migration handoff remain pending | [V2-CALL-01 callable ordinary-v2 execution plan](https://github.com/FS-GG/FS.GG.Coordination/blob/main/docs/roadmaps/callable-ordinary-v2-execution.md). Source delivery does not claim installed operation, external effects, `OpenV2`, Q4 or GS2-09 migration completion |
