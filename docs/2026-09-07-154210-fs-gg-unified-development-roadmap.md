...
| **V2 — Callable v2 and migration rehearsal** | **Ready to enter** | V1 is accepted through GS2-08.9; existing pure adapters, recovery contracts and qualification evidence are reusable inputs. | Deliver the installed ordinary entry point joining observation, decision, provider effects and recovery; complete GS2-09 representative migration, retry, rollback and omission proofs. |
...
1. **Enter V2 through GS2-09.** Deliver the installed callable path and representative migration, recovery, rollback
   and omission proofs while preserving the accepted V1 fence and keeping Q4 unclaimed.
...
| **Callable ordinary v2 execution** | V2: installed entry point joins observation, decision, provider effect and recovery, including routine delivery | Coordination; next executable window, using existing adapter/runtime contracts and registering only the actual missing wiring through its owner | Subroadmap is the first deliverable of the implementation window; no source implementation has started |
