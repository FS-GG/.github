...
| **V1 — Event/queue qualification and incumbent fencing** | **In progress; GS2-08.7 accepted, GS2-08.8 active** | GS2-07.1–07.8 and GS2-08.1–08.7 have accepted native receipts. The exact public 0.90.0 bridge is published and natively accepted; `.github` receiver window A adopts its pin and adds the shared revision/tree-bound proof. | Complete explicit receiver-family adoption in GS2-08.8, then disable or revoke bypassing and unavailable clients/routes in GS2-08.9 before entering V2. Q4 remains separately unclaimed. |
...
| **GS2-08.8 — Receiver adoption** | **In progress** | `.github` window A pins CLI 0.90.0 and supplies the shared explicit revision/tree, route, public-package, installed-command and fail-closed receiver proof. | Apply the evidence contract to the remaining receiver families and prove clean creation plus separately owned upgrades where applicable. |
| **GS2-08.9 — Disable residual writers** | **Pending** | The accepted census retains the old-client and direct-writer population. | Disable or revoke the observed 0.75.4 bypass, unavailable 0.58.0 client and residual direct workflow/script/publication/delivery writers. Q4 remains unclaimed. |

### 0.4 Active work and immediate critical path

1. **Continue GS2-08.8–08.9.** Complete exact 0.90.0 receiver adoption, then disable or revoke bypassing and
   unavailable clients/routes before entering V2.
...
| **Universal bridge and receiver fencing** | V1, GS2-08: protected epoch ledger, complete current-writer coverage, published bridge, receiver adoption and old-client refusal | `.github` bridge owner, with Coordination and receiver owners; GS2-08.1–08.7 are accepted and GS2-08.8 receiver adoption is active | [GS2-08.8 receiver adoption horizon](roadmaps/gs2-08-universal-v1-bridge.md#gs2-088-receiver-adoption--window-a) |
