...
| **V1 — Event/queue qualification and incumbent fencing** | **In progress; GS2-08.2–08.6 accepted** | GS2-07.1–07.8 and GS2-08.1–08.6 have accepted native receipts. The canonical ledger is initialized, the writer census and common effect fence are accepted, all current producer mutations use the durable fence, and independent Q3/Q6 attacks are accepted. | Publish/adopt the exact bridge through GS2-08.7–08.8, then disable or revoke bypassing and unavailable clients/routes in GS2-08.9 before entering V2. Q4 remains separately unclaimed. |
...
1. **Continue GS2-08.7–08.9.** Publish one immutable bridge, adopt its exact identity across receiver families,
   and disable or revoke bypassing and unavailable clients/routes before entering V2.
...
| **Universal bridge and receiver fencing** | V1, GS2-08: protected epoch ledger, complete current-writer coverage, published bridge, receiver adoption and old-client refusal | `.github` bridge owner, with Coordination and receiver owners; GS2-08.1–08.6 are accepted and GS2-08.7 immutable bridge publication is next | [GS2-08.7 immutable bridge publication horizon](roadmaps/gs2-08-universal-v1-bridge.md#ready-horizon-gs2-087-immutable-bridge-publication) |
