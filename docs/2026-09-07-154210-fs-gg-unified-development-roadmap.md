...
Last reconciled: **2026-09-11 18:35 UTC**. Current frontier: **V0 and V1 in parallel; the accepted SVG
workspace programme completed SVG-QUAL-01 and selects Astra planning for SVG-SCENE-02 next**.
...
3. **Plan SVG-SCENE-02 complete scene/renderer contract.** Use the completed installed model qualification to
   select the remaining C01–C03/C18/C19 scene, vector and browser surface for the first preview. Preserve the
   current Scene/SvgBrowser ownership, local-package boundary and strict S.I.R. read-only scope while Astra
   defines the next executable feature window.
