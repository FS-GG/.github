...
| **SVG-PREVIEW-C — Installed replay/network/scale preview** | **All packages published; public receivers next** | The [Release-C plan](roadmaps/svg-preview-c.md) targets Rendering 0.31.0, Game 0.16.0, Net 0.6.0 and Templates 0.13.0, retaining Audio 0.6.0 and SDD 1.7.0. | Producer and Templates publication are complete with dual-feed verification. Installed public qualification remains pending. |
...
Reconciled SVG feature-milestone states: **66 completed; SVG-PREVIEW-C.5 installed public qualification next**.
