...
| **SVG-PREVIEW-C — Installed replay/network/scale preview** | **Producers published; Templates adoption next** | The [Release-C plan](roadmaps/svg-preview-c.md) targets Rendering 0.31.0, Game 0.16.0, Net 0.6.0 and Templates 0.13.0, retaining Audio 0.6.0 and SDD 1.7.0. | Producer publication and dual-feed verification are complete. Templates adoption/publication and installed public qualification remain pending. |
...
Reconciled SVG feature-milestone states: **64 completed; SVG-PREVIEW-C.3 Templates adoption next**.
