...
| **SVG-PREVIEW-C — Installed replay/network/scale preview** | **Templates source adopted; publication next** | The [Release-C plan](roadmaps/svg-preview-c.md) targets Rendering 0.31.0, Game 0.16.0, Net 0.6.0 and Templates 0.13.0, retaining Audio 0.6.0 and SDD 1.7.0. | Producer publication and Templates source adoption are complete. Templates publication and installed public qualification remain pending. |
...
Reconciled SVG feature-milestone states: **65 completed; SVG-PREVIEW-C.4 Templates publication next**.
The latest published producer set is Rendering 0.31.0, Game 0.16.0, Net 0.6.0 and Audio 0.6.0.
Templates 0.12.0 remains the installed Release-B baseline. Release C owns Templates adoption/publication
and the remaining installed public proof. Provider, lifecycle and general template defaults remain unchanged.
...
| **SVG Preview C — SVG-PREVIEW-C** | Planned Templates 0.13.0 composes public Rendering 0.31.0, Game 0.16.0 and Net 0.6.0 for explicitly selected replay/network/scale previews | .3 first changes generated source composition; .2/.4 publish producers/Templates and .5 proves public clean creation and separate retained 0.10–0.12 adoption, conflicts, interruption and rollback. Producer publication (.2) and Templates source adoption (.3) are complete; Templates publication and receiver qualification remain pending. No lifecycle/default activation is implied. |
