...
**2026-09-12 15:14 UTC**. Current operational frontier: **V0 and V1 in parallel; SVG-PREVIEW-A is
complete through Release A and SVG-AUTHOR-01 is selected next**.
...
Reconciled SVG feature-milestone states: **20 completed; SVG-AUTHOR-01 selected next**.
Rendering 0.29.0 and Templates 0.11.0 are published and verified on both feeds; installed public receivers
close Release A without changing provider, lifecycle or general template defaults.
...
3. **Begin SVG-AUTHOR-01.** Release A is complete through the accepted
   [Preview-A subroadmap](roadmaps/svg-preview-a.md). Continue the ordered SVG programme with C04–C06 vector
   content, asset and scene authoring while preserving the opt-in/default boundary and installed-receiver
   evidence discipline.
