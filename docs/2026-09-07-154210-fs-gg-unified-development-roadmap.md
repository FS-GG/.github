...
Last reconciled: **2026-09-11 12:53 UTC**. Current frontier: **V0 and V1 in parallel, with the independent
SVG foundation track through SVG-FOUND-01.3**.
...
| **SVG-FOUND-01 — SVG game engine foundation** | **Retained browser adapter complete through .3** | Rendering PRs [#1279](https://github.com/FS-GG/FS.GG.Rendering/pull/1279) and [#1280](https://github.com/FS-GG/FS.GG.Rendering/pull/1280) delivered the portable retained Scene contract, curated Fable package path, package-only browser adapter, accessible pointer/keyboard and camera interaction, retained/stale-revision behavior, lifecycle proof and an explicit early browser-cost observation. | Exercise the neutral and S.I.R. consumers against candidate packages in .4; publication remains later. |
...
3. **SVG-FOUND-01.4 neutral and S.I.R. consumers.** Build on Rendering PR
   [#1280](https://github.com/FS-GG/FS.GG.Rendering/pull/1280) to exercise the neutral grid/continuous fixture and
   the bounded S.I.R. projection against candidate packages, preserving disclosed identities, camera and
   selection/focus behavior while keeping hidden facts absent. Keep producer/template publication as a separately
   evidenced later boundary.
...
| **SVG game engine foundation and Fable preview** | Section 15 independent producer/product track: portable Scene reuse, retained SVG interaction and neutral/S.I.R. consumers; bounded M0–M2 foundation with early M9/M10/M11 preparation; no V0–V6 completion prerequisite | `.github` planning owner, with Rendering, Templates and S.I.R.; Game retains its existing contracts. Start with bounded third-party provenance, Scene/Fable-closure and installed model-tool evidence; protected publication and later defaults remain separate | [SVG-FOUND-01 foundation subroadmap](roadmaps/svg-game-engine-foundation.md); preserves the [complete engine programme](2026-09-07-064259-svg-game-engine-template-design-roadmap.md) and [revision rationale](2026-09-07-121207-svg-game-engine-roadmap-revision-proposal.md) |
...
|---|---|---|
| [SVG game engine and Fable template](2026-09-07-064259-svg-game-engine-template-design-roadmap.md), with [SVG-FOUND-01 foundation window](roadmaps/svg-game-engine-foundation.md) and [revision rationale](2026-09-07-121207-svg-game-engine-roadmap-revision-proposal.md) | Product-owned incremental previews, beginning with a bounded executable foundation alongside V0–V1; modeled game/protocol semantics where relevant, published packages and generated-workspace journeys | Preserve Game/Rendering/Net/Audio/Template/S.I.R. ownership, capability scope and default-player distinction; source work and compatible previews have no V0–V6 completion prerequisite, while later defaults keep their own decision and epoch evidence |
