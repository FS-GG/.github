...
| **SVG-PREVIEW-C — Installed replay/network/scale preview** | **Selected** | The [Release-C plan](roadmaps/svg-preview-c.md) targets Rendering 0.31.0, Game 0.16.0, Net 0.6.0 and Templates 0.13.0, retaining Audio 0.6.0 and SDD 1.7.0. | Producer preparation/publication, Templates adoption/publication and installed public qualification remain pending. |
...
Reconciled SVG feature-milestone states: **62 completed; SVG-PREVIEW-C selected**.
...
| **SVG Preview C — SVG-PREVIEW-C** | Planned Templates 0.13.0 composes public Rendering 0.31.0, Game 0.16.0 and Net 0.6.0 for explicitly selected replay/network/scale previews | .3 first changes generated source composition; .2/.4 publish producers/Templates and .5 proves public clean creation and separate retained 0.10–0.12 adoption, conflicts, interruption and rollback. All remain pending; no lifecycle/default activation is implied. |
