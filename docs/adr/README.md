...
| [0019](0019-platform-workspace-component-vocabulary.md) | Name the two products precisely — **platform** (the org), **component** (one repo), **workspace** (what you scaffold); "product" was overloaded | Accepted |
