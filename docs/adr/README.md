...
| [0016](0016-retire-templates-local-new-fullstack-single-scaffolder.md) | Retire the Templates-local `new-fullstack.sh`; `new-sdd-fullstack` is the sole full-stack scaffolder (completes 0010's withdrawal; reimplemented 2026-07-04 as the `FS.GG.NewSddFullstack` dotnet tool) | Accepted |
