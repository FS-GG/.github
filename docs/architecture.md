...
FS.GG.Templates owns one `FS.GG.Workspace.Template` package (registry `package-version` **0.13.0** —
...
(its consumed version — distinct from the registry's newest-tracking 0.13.0 pin above; S.I.R. has
...
| `coord-engine` | FS-GG/.github | `0.89.0` | `0.88.0` |
