...
| 7 | **SVG-RUNTIME-01 — Sessions and continuous gameplay** | Deliver C08/C10 runtime, fixed-step sessions, collision and representative continuous gameplay | **Selected next.** Game owns the portable session/collision authority, Rendering owns the browser clock/projection host, and Templates owns the generated continuous-game journey |
