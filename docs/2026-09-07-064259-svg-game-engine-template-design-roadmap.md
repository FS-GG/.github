...
| 14 | **SVG-WORKSPACE-01 — Complete generated workspace** | Complete C20 skills, samples, documentation, packaging, upgrade and section 13 journeys | **Selected** through the [Templates-owned workspace subroadmap](https://github.com/FS-GG/FS.GG.Templates/blob/main/docs/roadmaps/svg-workspace-01.md), first window .1–.3. Installed receiver/development/deployment evidence remains required; lifecycle/default effects retain their actual prerequisites |
