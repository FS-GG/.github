...
| 6 | **SVG-INPUT-01 — Command and workspace interaction** | Deliver C07/C09 commands, docking, keybindings, modal input and accessible device parity | **Selected next.** Rendering input/workspace contracts and browser accessibility evidence; generated candidate integration remains Templates-owned |
