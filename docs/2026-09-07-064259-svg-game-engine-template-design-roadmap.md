...
| 11 | **SVG-NETWORK-01 — Multiplayer and resync** | Deliver C17 two-client gameplay, reconnect, stale-input refusal and resync | **Selected next** through the [Network subroadmap](roadmaps/svg-network-01.md). Game/Net/Templates owner contracts and real multi-client journeys |
...
**SVG-NETWORK-01** through its [Network subroadmap](roadmaps/svg-network-01.md).
