...
- **Scope:** The **pathfinding & navigation** game-logic skill — what
  `FS.GG.UI.Canvas.Pathfinding` (today: deterministic A*/BFS over a walkability predicate,
...
- **Home:** `FS.GG.Rendering`, extending `FS.GG.UI.Canvas.Pathfinding`; depends *down* only.
