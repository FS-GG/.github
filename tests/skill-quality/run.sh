...
python3 "$ROOT/tests/skill-quality/roadmap-telemetry.py"
python3 "$ROOT/tests/skill-quality/native-collaboration-usage.py"
python3 "$ROOT/tests/skill-quality/routine-observer.py"
python3 "$ROOT/tests/skill-quality/routine-telemetry-safety.py"
python3 "$ROOT/tests/skill-quality/routine-cohort.py"
python3 "$ROOT/tests/skill-quality/release-operation.py"
