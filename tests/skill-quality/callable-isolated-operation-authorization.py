...
def valid_args(**changes):
    values = {
        ...
        "authority_repository": grant.AUTHORITY_REPOSITORY,
        "authority_event": "workflow_dispatch",
...
class CallableIsolatedOperationAuthorizationTests(unittest.TestCase):
    ...
    def test_grant_matches_coordination_contract_and_is_canonical(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            command = [
                ...
                "--authority-repository", grant.AUTHORITY_REPOSITORY,
                "--authority-event", "workflow_dispatch", "--authority-ref", "refs/heads/main",
    ...
    def test_contract_revision_authority_identity_and_time_drift_refuse(self):
        cases = (
            ...
            ("authority_repository", "FS-GG/other"),
            ("authority_event", "push"),
            ("authority_ref", "refs/heads/topic"),
