...
# Repair Phase Live Assertion Writer Checklist

Prose status: checklistReady

## Source Specification
- work/3068-repair-phase-live-assertion-writer/spec.md
...
- Next lifecycle action: `fsgg-sdd plan --work 3068-repair-phase-live-assertion-writer`.
