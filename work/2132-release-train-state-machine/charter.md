...
# Coord release: resumable cross-repo NuGet train state machine Charter

## Identity
- Work id: `2132-release-train-state-machine`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 2132-release-train-state-machine`.
