...
# Preserve canonical external-owner identity across scheduler and claim paths Charter

## Identity
- Work id: `2155-external-owner-identity`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 2155-external-owner-identity`.
