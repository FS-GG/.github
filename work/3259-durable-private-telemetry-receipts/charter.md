...
# Durable private telemetry receipts Charter

## Identity
- Work id: `3259-durable-private-telemetry-receipts`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 3259-durable-private-telemetry-receipts`.
