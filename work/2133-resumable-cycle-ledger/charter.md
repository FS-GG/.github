...
title: Coordination cycle ledger
stage: charter
changeTier: tier1
status: chartered
policyPointers:
...
# Coordination cycle ledger Charter

## Identity
- Work id: `2133-resumable-cycle-ledger`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 2133-resumable-cycle-ledger`.
