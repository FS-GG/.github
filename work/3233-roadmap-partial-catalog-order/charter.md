...
# Accept ordered partial roadmap catalogs Charter

## Identity
- Work id: `3233-roadmap-partial-catalog-order`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 3233-roadmap-partial-catalog-order`.
