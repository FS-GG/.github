...
# Workspace Provider Activation Charter

## Identity
- Work id: `2070-workspace-provider-activation`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 2070-workspace-provider-activation`.
