...
- AC-004 [US-002] [FR-004]: Given the public CLI command is requested, when the writer succeeds or live review state is inspected, then output names the exact next action and command derived from typed live authority.
...
- FR-004: The CLI contract and live oracle MUST render the exact authorized writer or next command, including all required bindings, rather than requiring hand-authored authority. (Stories: US-002; Acceptance: AC-004)
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd clarify --work 107-repair-phase-live-assertion-writer`.
