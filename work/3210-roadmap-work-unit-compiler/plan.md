...
## Source Snapshot
- spec: work/3210-roadmap-work-unit-compiler/spec.md sha256:143680caafdf93a3d6441e534732043dd50cc365ee40a7927a97c825e6e9c6cd schemaVersion:1
- clarifications: work/3210-roadmap-work-unit-compiler/clarifications.md sha256:89e580141f45e2f9261182fe872ed2476f6000b6f162ddf2aa6984ba7a185eef schemaVersion:1
...
- PD-003 [AC-003] [FR-003] complete: Recompile the plan from immutable cross-repository roadmap/catalog files, compose lifecycle export and structured-review validation over live GitHub facts and the winning claim, rerun qualification through its production executor, independently rerun pinned SDD in a fresh remote checkout, and bind its artifacts to immutable candidate files.
...
- PD-005 [AC-005] [FR-005] complete: Add explicit implementation/acceptance PR and five-revision identities; observe merged PR facts, remote commit trees, protected-main tip, and acceptance merge time before sealing.
...
- PD-007 [AC-007] [FR-007] complete: Expose pure preparation and acceptance-candidate `inspect|render|verify`; board-ops applies drafts through existing intake and exclusively owns `roadmap unit accept seal`, the only accepted-receipt constructor.
...
- PC-003 [PD-007] commandReport: `roadmap unit prepare|accept inspect|render|verify` is deterministic and non-authoritative; `roadmap unit accept seal` performs fail-closed live observations and alone emits accepted output.
...
- VO-005 [PD-005] [PC-002] mutationTest: Every forbidden identity collapse and remote candidate/merge tree substitution is inverted independently.
