...
| 4 | `### Worked example` | **do-not-restore** | Illustration, not contract. It demonstrates steps 5 and 7 against `FS.GG.Templates#379`; its three generalised fixture properties are carried by the restored step 5 and new step 7. The narrative survives in git and on that issue. Restoring it would grow the file without adding an obligation. |
