...
# P4 Typed SDD registry and workspace creation contracts Charter

## Identity
- Work id: `typed-sdd-p4-registry`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work typed-sdd-p4-registry`.
