...
# Typed delivery merge-method policy Charter

## Identity
- Work id: `3091-delivery-merge-method-policy`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 3091-delivery-merge-method-policy`.
