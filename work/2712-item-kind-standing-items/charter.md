...
# Item Kind and the standing-item reducer exemption Charter

## Identity
- Work id: `2712-item-kind-standing-items`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 2712-item-kind-standing-items`.
