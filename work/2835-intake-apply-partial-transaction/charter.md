...
# Intake Apply Partial Transaction Charter

## Identity
- Work id: `2835-intake-apply-partial-transaction`
...
## Lifecycle Notes
- Next lifecycle action: `fsgg-sdd specify --work 2835-intake-apply-partial-transaction`.
