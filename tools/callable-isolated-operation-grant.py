...
def parser() -> argparse.ArgumentParser:
    ...
    result.add_argument("--authority-event", required=True)
    result.add_argument("--authority-ref", required=True)
...
def build(args: argparse.Namespace) -> dict[str, object]:
    ...
    exact("authority repository", args.authority_repository, AUTHORITY_REPOSITORY)
    exact("authority event", args.authority_event, "workflow_dispatch")
    exact("authority ref", args.authority_ref, "refs/heads/main")
