#!/usr/bin/env python3
"""Publish the exact Host 0.1.5 candidate through fresh admitted effects."""
...
REF = "refs/heads/fsgg/v2/journal/release/utel-host-rel-04"
...
def main() -> int:
    ...
    try:
        ...
        intent = {"contentId": content_id, "sourceSha": candidate_source, "version": "0.1.5",
